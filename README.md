...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y9n5coq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y9n5coq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Mohanrajcr/container-y9n5coq.git
cd container-y9n5coq
```
...
```
docker attach container-y9n5coq
```
